...
│               ├── SKILL.md          # 技能主文件
│               ├── 规范一_内容结构规范.md  # 内容结构规范
│               ├── 规范二_写作规范.md      # 写作规范
│               ├── 规范三_专业结合规范.md  # 专业结合规范
│               ├── 规范四_评分标准规范.md  # 评分标准规范
│               └── assets/           # 资源目录
│                   ├── topic.md      # 主题锚定规范
│                   ├── voice.md      # 语气风格规范
│                   ├── structure.md  # 结构提纲规范
...
├── env.example         # 环境变量模板
├── README.md           # 项目说明文档
└── 《边城》读书心得_和谐共生智慧与软件工程人才成长.md  # 示例读书心得
```
...
| 文件名称 | 内容概述 |
|----------|----------|
| 规范一_内容结构规范.md | 文章结构框架，包括六个部分的详细要求和字数分配 |
| 规范二_写作规范.md | 格式规范、语言要求、引用规范、图表规范等技术要求 |
| 规范三_专业结合规范.md | 数据结构视角、算法思维视角、软件工程原则等专业结合维度 |
| 规范四_评分标准规范.md | 评分维度体系、各维度详细标准、成绩等级划分等 |
...
**文件位置：** `《边城》读书心得_和谐共生智慧与软件工程人才成长.md`
